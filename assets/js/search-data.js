    ...
    handler: () => {
      window.location.href = "/website/";
        ...
        handler: () => {
          ...
          description: "",
          section: "News",},{id: "projects-turn-taking-for-robotic-musicians",
          ...
          section: "Projects",handler: () => {
            ...
            },},{id: "projects-dynamic-guitar-amp",
          ...
          section: "Projects",handler: () => {
            ...
            },},{id: "projects-a-comparison-of-chinese-and-german-lullabies",
          ...
          section: "Projects",handler: () => {
            ...
            },},{id: "projects-buzz-mascot-program",
          title: 'Buzz Mascot Program',
          description: "",
          section: "Projects",handler: () => {
              window.location.href = "/website/projects/6_project/";
            },},{id: "projects-inventory-amp-checkout-system",
          title: 'Inventory &amp;amp; Checkout System',
          description: "PowerApps scripting for School of Music",
          section: "Projects",handler: () => {
          ...
          section: "Projects",handler: () => {
            ...
            },},{id: "teachings-musi-2525-intro-to-audio-tech-i",
          title: 'MUSI 2525 Intro to Audio Tech I',
          description: "This course covers the fundamentals of audio technology. Student learning outcomes include deep understanding and practical familiarity with concepts such as signals and systems, electro-acoustics, sound effects, synthesis, and music protocols.",
          section: "Teachings",handler: () => {
              window.location.href = "/website/teachings/audio-tech-1/";

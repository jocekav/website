...
I designed the GUI initially in Figma, then built the functional version using the JUCE visual library. The GUI was connected using JUCE's value state tree to control the preset, effect, and model states.
